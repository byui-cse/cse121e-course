...
%%@doc The <kbd>for/1</kbd> function returns the product of all elements of the parameter of type list. The list can be empty.
...
%% <ol>
%%   <li>multiplication of all elements of a list of numbers (BigO(n)), and</li>
